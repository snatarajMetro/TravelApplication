...
namespace TravelApplication.DAL.Repositories
{
    ...
    public class DocumentsRepository : IDocumentsRepository
    {
        ...
        public List<Models.SupportingDocument> GetAllDocumentsByTravelId(int travelRequestId, int badgeNumber)
        {
            List<Models.SupportingDocument> result = new List<Models.SupportingDocument>();
            using (dbConn = ConnectionFactory.GetOpenDefaultConnection())
            {
                ...
                if (dataReader != null)
                {
                    ...
                    {
                        result.Add(new Models.SupportingDocument() {
