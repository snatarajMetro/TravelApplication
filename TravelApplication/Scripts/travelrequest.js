...
app.controller('travelAppCtrl', function ($scope, $compile, $timeout, uiGridConstants) {
    ...
    $scope.loadSubmitDetails = function (travelRequestId) {
        ...
        var isAdminRole = ($("#selectedRoleId").text() == 4);
        ...
        .done(function (data) {
            ...
            if (parseInt(data.TravelRequestSubmitDetail.DepartmentHeadBadgeNumber) == -1) {
                ...
                if (data.TravelRequestSubmitDetail.RejectedTravelRequest && (!isAdminRole)) {
    ...
    $scope.loadSubmitDetailsForReimbursement = function (travelRequestId) {

        var url = "api/reimburse/submitdetails/" + travelRequestId;
